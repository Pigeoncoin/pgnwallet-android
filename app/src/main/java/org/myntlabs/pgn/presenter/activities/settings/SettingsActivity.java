...
import org.myntlabs.pgn.presenter.activities.CurrencySettingsActivity;
import org.myntlabs.pgn.presenter.activities.UpdatePinActivity;
import org.myntlabs.pgn.presenter.activities.util.BRActivity;
import org.myntlabs.pgn.presenter.entities.BRSettingsItem;
...
import static org.myntlabs.pgn.R.layout.settings_list_item;
import static org.myntlabs.pgn.R.layout.settings_list_section;
...
//        }
        ...
        items.add(new BRSettingsItem(getString(R.string.Settings_pgn), "", new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SettingsActivity.this, CurrencySettingsActivity.class);
                BRSharedPrefs.putCurrentWalletIso(app, "PGN"); //change the current wallet to the one they enter settings to
                startActivity(intent);
                overridePendingTransition(R.anim.enter_from_right, R.anim.exit_to_left);
            }
        }, false));
        ...
        items.add(new BRSettingsItem(getString(R.string.Settings_review), "", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent appStoreIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + "org.myntlabs.pgn"));
                    appStoreIntent.setPackage("com.android.vending");

                    startActivity(appStoreIntent);
                } catch (android.content.ActivityNotFoundException exception) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=" + "org.myntlabs.pgn")));
                }
                overridePendingTransition(R.anim.enter_from_right, R.anim.exit_to_left);
            }
        }, false));

        items.add(new BRSettingsItem(getString(R.string.Settings_aboutPigeon), "", new View.OnClickListener() {
            @Override
            public void onClick(View v) {
