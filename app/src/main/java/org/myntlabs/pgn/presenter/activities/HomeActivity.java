package org.myntlabs.pgn.presenter.activities;
...
import org.myntlabs.pgn.presenter.activities.settings.SecurityCenterActivity;
import org.myntlabs.pgn.presenter.activities.settings.SettingsActivity;
...
import org.myntlabs.pgn.presenter.customviews.BRButton;
import org.myntlabs.pgn.presenter.customviews.BRDialogView;
import org.myntlabs.pgn.presenter.customviews.BRNotificationBar;
import org.myntlabs.pgn.presenter.customviews.BRText;
import org.myntlabs.pgn.tools.adapter.WalletListAdapter;
import org.myntlabs.pgn.tools.animation.BRAnimator;
import org.myntlabs.pgn.tools.animation.BRDialog;
import org.myntlabs.pgn.tools.listeners.RecyclerItemClickListener;
...
import org.myntlabs.pgn.tools.manager.PromptManager;
import org.myntlabs.pgn.tools.manager.SyncManager;
...
public class HomeActivity extends BRActivity implements InternetManager.ConnectionReceiverListener, SyncManager.OnProgressUpdate {
    ...
    private RelativeLayout mSwiftex;
    private RelativeLayout mCryptobridge;
    private RelativeLayout mSafe;
    private RelativeLayout mAltm;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSwiftex = findViewById(R.id.swiftex_row);
        mCryptobridge = findViewById(R.id.cryptobridge_row);
        mAltm = findViewById(R.id.altm_row);
        mSafe = findViewById(R.id.safe_row);
...
//                Log.d("HomeActivity", "Saving current wallet ISO as " + mAdapter.getItemAt(position).getIso(HomeActivity.this));
        ...
        mSwiftex.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent browserIntent = new Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("https://swiftex.co"));
                startActivity(browserIntent);
            };
        });
        mCryptobridge.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent browserIntent = new Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("https://crypto-bridge.org"));
                startActivity(browserIntent);
            };
        });
        mSafe.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent browserIntent = new Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("https://safe.trade"));
                startActivity(browserIntent);
            };
        });
        mAltm.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent browserIntent = new Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("https://altmarkets.io"));
                startActivity(browserIntent);
            };
        });
