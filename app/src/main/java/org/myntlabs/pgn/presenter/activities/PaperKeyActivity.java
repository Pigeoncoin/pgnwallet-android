...
import org.myntlabs.pgn.presenter.fragments.FragmentPhraseWord;
...
public class PaperKeyActivity extends BRActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(PaperKeyActivity.this);

        builder.setCancelable(false);

        builder.setTitle("Welcome!");
        builder.setMessage("Few things to note.\n\nKeys are case sensitive. Please double check each key before proceeding.\n\nOn first run, the sync time will take a while. After this each boot won't take as long.");
...
//        });
        ...
        if (cleanPhrase.charAt(cleanPhrase.length() - 1) == '\0') {
            ...
            BRReportsManager.reportBug(new IllegalArgumentException("Paper Key error, please contact support at pigeoncoin.org: " + wordArray.length), true);
        } else {
