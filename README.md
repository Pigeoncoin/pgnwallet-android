...
Unlike many other wallets, This wallet is a real standalone Pigeoncoin client. There is no server to get hacked or go down, so you can always access your money. Using [SPV](https://en.bitcoin.it/wiki/Thin_Client_Security#Header-Only_Clients) mode, This wallet connects directly to the Pigeoncoin network with the fast performance you need on a mobile device.
