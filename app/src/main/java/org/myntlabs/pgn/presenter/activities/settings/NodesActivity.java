...
//    private TextView nodeLabel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BRSharedPrefs.putCurrentWalletIso(this, "PGN");
        ...
        switchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final PgnWalletManager wm = PgnWalletManager.getInstance(NodesActivity.this);
    ...
    private void updateButtonText() {
        PgnWalletManager wm = PgnWalletManager.getInstance(this);
    ...
    private void createDialog() {
        ...
        mDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final PgnWalletManager wm = PgnWalletManager.getInstance(app);
